...
def main():
  ...
  replace_ffn_linears_with_fp8(low_model)                    # FP8 for low-noise steps only
  replace_last_n_attn_with_rowwise_fp8(low_model, n=40)      # rowwise FP8 uses faster cuBLAS kernel (128x128 vs 128x160)
