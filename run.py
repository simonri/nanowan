...
from model import WanModel, replace_attn_linears_with_fp8, replace_ffn_linears_with_fp8, replace_last_n_attn_with_rowwise_fp8, replace_last_n_ffn_with_fp8, replace_last_n_self_attn_with_rowwise_fp8
from prepare import (
  DIT_DTYPE,
  FLOW_SHIFT,
  HEIGHT,
...
def main():
  ...
  replace_last_n_attn_with_rowwise_fp8(high_model, n=15)   # last 15/40 blocks: self+cross rowwise FP8
  replace_last_n_self_attn_with_rowwise_fp8(high_model, n=16)  # probe: block 24 self-attn only (not cross-attn)
