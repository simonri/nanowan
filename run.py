...
from model import WanModel, replace_attn_linears_with_fp8, replace_ffn_linears_with_fp8, replace_last_n_attn_with_rowwise_fp8, replace_last_n_ffn_with_fp8, precompute_cross_attn_kv
from prepare import (
  DIT_DTYPE,
  FLOW_SHIFT,
  HEIGHT,
...
def main():
  ...
  # Cache cross-attn K/V (text embedding is constant across all denoising steps)
  _enc_precompute = prompt_embeds.to(DEVICE, dtype=DIT_DTYPE)
  precompute_cross_attn_kv(high_model, _enc_precompute)
  precompute_cross_attn_kv(low_model, _enc_precompute)
