...
from model import WanModel, replace_attn_linears_with_fp8, replace_ffn_linears_with_fp8, replace_first_n_cross_attn_qo_with_rowwise_fp8, replace_last_n_attn_with_rowwise_fp8, replace_last_n_ffn_with_fp8
from prepare import (
  DIT_DTYPE,
  FLOW_SHIFT,
  HEIGHT,
...
def main():
  ...
  replace_first_n_cross_attn_qo_with_rowwise_fp8(high_model, n=25)  # cross-attn Q/O blocks 0-24 FP8
